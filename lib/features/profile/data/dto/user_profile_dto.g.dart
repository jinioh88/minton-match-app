...
_UserProfileDto _$UserProfileDtoFromJson(Map<String, dynamic> json) =>
    _UserProfileDto(
      ...
      receivedReviewCount: (json['receivedReviewCount'] as num?)?.toInt(),
      hostedMatchCount: (json['hostedMatchCount'] as num?)?.toInt(),
      participatedMatchCount: (json['participatedMatchCount'] as num?)?.toInt(),
      showCautionBadge: json['showCautionBadge'] as bool?,
      participationBannedUntil: json['participationBannedUntil'] as String?,
...
Map<String, dynamic> _$UserProfileDtoToJson(_UserProfileDto instance) =>
    <String, dynamic>{
      ...
      'receivedReviewCount': instance.receivedReviewCount,
      'hostedMatchCount': instance.hostedMatchCount,
      'participatedMatchCount': instance.participatedMatchCount,
      'showCautionBadge': instance.showCautionBadge,
      'participationBannedUntil': instance.participationBannedUntil,
