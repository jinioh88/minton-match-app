...
import '../auth/session_expiry_handler.dart';
...
final onUnauthorizedProvider = Provider<void Function()?>(
  (ref) => () {
    ref.read(sessionExpiryHandlerProvider).handleExpiredSession();
  },
);
...
final dioProvider = Provider<Dio>((ref) {
  ...
  dio.interceptors.add(AuthInterceptor(() => ref.read(accessTokenProvider)));
